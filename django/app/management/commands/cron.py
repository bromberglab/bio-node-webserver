...
def cron_worker():
    ...
    from .uploads import cron as uploads_cron
    ...
    from app.util import check_filters
    ...
    tasks = [
        ...
        # ...
        CronTask("images_cron", 5 * minutes, images_cron),
        ...
        CronTask("uploads_cron", 1.3 * days, uploads_cron),
        ...
        CronTask("check_filters", 2 * days, check_filters),
    ]
